...
### Alterado
- **Status do SAP mais rápido no portal**: a verificação de notas fiscais no SAP passou de 20 para 5 minutos e o lote subiu de 50 para 90 pedidos, com os pedidos recentes consultados em toda execução e o histórico antigo em rodízio. Antes um pedido faturado podia levar mais de uma hora para atualizar; agora aparece em até ~5 minutos.
...
### Corrigido
- **Ordem de venda no SAP com a tabela de preço da proposta**: o portal enviava a tabela 1 (varejo) fixa em todos os pedidos, então o SAP reprecificava a ordem e o total saía diferente do valor fechado com o cliente (pedido 60350 fechou R$ 22.600 na tabela 3 e a ordem 17805 saiu com R$ 27.365,83). Agora a tabela da proposta vai no pedido e, nas vendas para a Zona Franca de Manaus, a ordem leva uma observação com a inscrição SUFRAMA e as regras fiscais (sem PIS/COFINS, sem IPI, ICMS 4% em importados e isenção nos nacionais).
