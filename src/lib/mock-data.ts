...
export const clients: Client[] = [
  { id: "1", name: "GTC Engenharia LTDA", segment: "A", projection: 34874, generation: 10777, sales: 8200, trend: "up", lastInteraction: "2d", health: 78, notes: "Cliente pediu condição de pagamento estendida na última call. Avaliar 60/90 dias para o próximo pedido." },
  { id: "2", name: "Ecolatto Energia Gestão", segment: "B", projection: 7058, generation: 7741, sales: 6900, trend: "up", lastInteraction: "1d", health: 92, notes: "Recompra mensal estável. Bom candidato para upsell em acessórios." },
  { id: "3", name: "ALC Solar - Renováveis", segment: "A", projection: 27205, generation: 14200, sales: 9800, trend: "down", lastInteraction: "12d", health: 38, notes: "Mencionou cotação concorrente da DistribuidoraX. Risco real — necessário ligação." },
  { id: "4", name: "Antonia Tania Pereira", segment: "A", projection: 31035, generation: 22100, sales: 18500, trend: "up", lastInteraction: "3d", health: 71, notes: "Está fechando contrato grande de usina; pedir previsão de OC." },
  { id: "5", name: "Cipriani Engenharia Solar", segment: "A", projection: 55662, generation: 31200, sales: 24800, trend: "stable", lastInteraction: "5d", health: 65, notes: "Demonstrou interesse na linha premium de limpadores na última visita." },
  { id: "6", name: "Economy Solar LTDA", segment: "A", projection: 17729, generation: 4200, sales: 2100, trend: "down", lastInteraction: "18d", health: 22, notes: "Sem retorno desde 11/06. Tentar contato com novo decisor." },
  { id: "7", name: "Elo Solar LTDA", segment: "A", projection: 10916, generation: 9800, sales: 9100, trend: "up", lastInteraction: "1d", health: 88, notes: "Carteira saudável, comprando alinhado à projeção." },
  { id: "8", name: "Enertrend Equipamentos", segment: "A", projection: 14248, generation: 6100, sales: 4200, trend: "down", lastInteraction: "9d", health: 44, notes: "Estoque parado, sinalizou que vai segurar pedidos no curto prazo." },
  { id: "9", name: "Gualberto & Lazarotto", segment: "A", projection: 22475, generation: 18200, sales: 15600, trend: "up", lastInteraction: "2d", health: 81, notes: "Pediu apresentação técnica para a equipe deles na próxima quarta." },
  { id: "10", name: "Hoger Soluções em Energia", segment: "B", projection: 5533, generation: 3200, sales: 2800, trend: "stable", lastInteraction: "6d", health: 58, notes: "Comprador habitual, sem novidades." },
  { id: "11", name: "Jislaine Farias dos Anjos", segment: "A", projection: 26381, generation: 19200, sales: 16800, trend: "up", lastInteraction: "1d", health: 84, notes: "Aprovou nova proposta — aguardando emissão da OC." },
  { id: "12", name: "JN Construções Ecoeficientes", segment: "B", projection: 9235, generation: 2100, sales: 980, trend: "down", lastInteraction: "21d", health: 18, notes: "Cliente com pendência financeira — bloqueado por crédito." },
  { id: "13", name: "Maxpower Comércio Placas", segment: "B", projection: 9700, generation: 8200, sales: 7600, trend: "up", lastInteraction: "3d", health: 79, notes: "Sinalizou aumento de demanda em julho." },
  { id: "14", name: "NG Solar LTDA", segment: "B", projection: 8768, generation: 5100, sales: 4200, trend: "stable", lastInteraction: "7d", health: 62, notes: "Sem observações relevantes no Salesforce." },
  { id: "15", name: "Palmas Energia Solar", segment: "B", projection: 9023, generation: 4800, sales: 3900, trend: "down", lastInteraction: "11d", health: 41, notes: "Pediu desconto adicional na última cotação — em análise." },
  { id: "16", name: "Retrofit Elétrica Industrial", segment: "C", projection: 10813, generation: 6200, sales: 5100, trend: "up", lastInteraction: "4d", health: 68, notes: "Projeto industrial em andamento; abrir conversa sobre próxima fase." },
  { id: "17", name: "Rodotech Energia Solar", segment: "C", projection: 10215, generation: 7800, sales: 6900, trend: "up", lastInteraction: "2d", health: 75, notes: "Boa conversão recente; explorar acessórios de limpeza." },
  { id: "18", name: "Sol Engenharia Energéticas", segment: "A", projection: 37657, generation: 28200, sales: 24100, trend: "up", lastInteraction: "1d", health: 86, notes: "Conta âncora — ritmo de fechamento alto, follow-up semanal." },
  { id: "19", name: "Solaron Franquias LTDA", segment: "C", projection: 8633, generation: 1200, sales: 600, trend: "down", lastInteraction: "25d", health: 12, notes: "Cliente franquia, contato perdido com decisor anterior." },
  { id: "20", name: "Solarwave Energia", segment: "D", projection: 5993, generation: 4100, sales: 3800, trend: "stable", lastInteraction: "8d", health: 55, notes: "Compra eventual, sem padrão definido." },
  { id: "21", name: "Vertice Construtora Solar", segment: "A", projection: 79215, generation: 62100, sales: 54200, trend: "up", lastInteraction: "1d", health: 91, notes: "Top 1 da carteira. Acompanhar de perto: cotação grande em negociação (ORC-9821)." },
];
