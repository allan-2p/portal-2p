...
## Moderação (01/09)
- [x] Migrar Produtos e Estoque de Configurações > Objetos e Campos para Moderação, separados por 2P Solar, 2P Carregadores e Grupo 2P (nova aba Grupo 2P com todos os produtos).
- [x] Corrigir os links de Catálogo na navegação da Moderação para abrir a unidade selecionada sem cair na tela de erro.
