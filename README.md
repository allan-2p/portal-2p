...
| **solar** | 16 | `/solar/atlas`, `/solar/clientes`, `/solar/clientes/cadastros`, `/solar/clientes/negocios`, `/solar/clientes/perfil`, `/solar/clientes/ranking`, `/solar/clientes/segmentacao`, `/solar/clientes/sugestoes`, `/solar/cupons`, `/solar/dashboards`, `/solar/dashboards/metas`, `/solar/estoque`, `/solar/pedidos`, `/solar/propostas`, `/solar/propostas/nova`, `/solar/tarefas` |
<!-- /readme:rotas -->
...
<!-- readme:env -->
Fonte da verdade: [`.env.example`](./.env.example) — 76 variáveis, sendo 2 pública(s) no client (`VITE_*`).
...
| **Fretefy** | `FRETEFY_TOKEN`, `FRETEFY_WEBHOOK_USER`, `FRETEFY_WEBHOOK_PASSWORD` |
| **SharePoint / Microsoft Graph (boletos a prazo)** | `SHAREPOINT_TENANT_ID`, `SHAREPOINT_CLIENT_ID`, `SHAREPOINT_CLIENT_SECRET`, `SHAREPOINT_SITE_HOSTNAME`, `SHAREPOINT_SITE_PATH`, `SHAREPOINT_BOLETOS_PASTA`, `BOLETOS_SP_JANELA_DIAS` |
| **Consulta de CNPJ / CPF** | `CNPJA_API_KEY`, `SERPRO_CONSUMER_KEY`, `SERPRO_CONSUMER_SECRET` |
| **Notificações / IA** | `KIT_NOTIFICACAO_EMAIL`, `EMAIL_COPIA_REGISTRO`, `CANCELAMENTO_NOTIFICACAO_EMAIL`, `SAP_OV_CANCELAR_URL`, `LOVABLE_API_KEY`, `LOVABLE_SEND_URL` |
<!-- /readme:env -->
