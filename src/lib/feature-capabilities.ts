...
const MAP: Partial<Record<FeatureKey, CapabilityId[]>> = {
  ...
  "carregadores.visao-geral.valores": V,
  ...
  "admin.comissoes": VEM,
  "admin.tabelas": VEM,
  "carregadores.produtos": VEM,
  "carregadores.comissoes": VEM,
  "carregadores.regras": VEM,
  "carregadores.metas": VEM,
  // Integrações
