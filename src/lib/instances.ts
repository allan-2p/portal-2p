...
export const ROUTE_FEATURE: Partial<Record<AppPath, FeatureKey>> = {
  ...
  "/admin/modulos-solar": "admin.regras",
  "/admin/trilhos-solar": "admin.regras",
  "/admin/suportes-solar": "admin.regras",
  "/admin/microinversores-solar": "admin.regras",
  ...
  "/carregadores/lotes": "carregadores.regras",
  "/admin/comissoes": "admin.comissoes",
  "/admin/tabelas": "admin.tabelas",
  "/admin/grupo-2p": "admin.objetos.produtos",
...
export const FEATURE_LABELS: Record<FeatureKey, string> = {
  ...
  "admin.objetos.produtos": "Moderação • Grupo 2P — Catálogo e Estoque do SAP",
  "admin.perfis": "Admin • Perfis",
