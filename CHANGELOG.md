...
### Corrigido
- **Validação SUFRAMA preservada nas propostas Solar**: inscrição e situação do CNPJ de faturamento direto agora permanecem salvas ao sair e reabrir a proposta; ao trocar o documento, a validação anterior é limpa para não ser reaproveitada em outro cliente.
