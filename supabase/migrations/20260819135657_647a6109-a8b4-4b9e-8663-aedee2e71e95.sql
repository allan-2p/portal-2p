...
-- Campos de pagamento (Pix / boleto)
alter table public.propostas
  add column if not exists pagamento_meio text,
  add column if not exists pagamento_status text,
  add column if not exists pagamento_txid text,
  add column if not exists pagamento_e2eid text,
