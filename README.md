...
<!-- readme:env -->
Fonte da verdade: [`.env.example`](./.env.example) — 69 variáveis, sendo 2 pública(s) no client (`VITE_*`).
...
| **SAP** | `SAP_BRIDGE_URL`, `SAP_BRIDGE_USER`, `SAP_BRIDGE_PASSWORD`, `SAP_BRIDGE_AUTH`, `SAP_RFC_URL`, `SAP_RFC_TOKEN`, `SAP_SIMULAR_URL`, `SAP_OV_CRIAR_URL`, `SAP_OV_AUTH`, `SAP_OV_FILIAL`, `SAP_OV_TESTRUN`, `SAP_OV_ZTERM_VISTA`, `SAP_OV_ZTERM_PIX`, `SAP_OV_ZTERM_CARTAO`, `SAP_CLIENTES_URL`, `SAP_CLIENTES_AUTH`, `SAP_NFS_URL`, `SAP_NFS_AUTH`, `SAP_ZMMR059_URL`, `SAP_ZMMR059_AUTH`, `SAP_FILIAIS` |
