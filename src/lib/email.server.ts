 ...
 *
 * Implementação em `./email-layout` (módulo puro) para que o painel de
 * controle de e-mails renderize a prévia com o mesmo HTML do envio real.
 */
export { layoutEmail } from "./email-layout";
